package components 
{
	...
	public class Sounds extends	EventDispatcher
	{
		...
		[Embed(source="../../media/sounds/Shoot1.mp3")]			//Embed Shoot Sound 1 file
		static private const sShoot1:Class;
		
		[Embed(source="../../media/sounds/Shoot2.mp3")]			//Embed Shoot Sound 2 file
		static private const sShoot2:Class;
		
		[Embed(source="../../media/sounds/Shoot3.mp3")]			//Embed Shoot Sound 3 file
		static private const sShoot3:Class;
		
		[Embed(source="../../media/sounds/SoundExplosion.mp3")]	//Embed Eplosion Sound file
		static private const sExplosion:Class;
		
		[Embed(source="../../media/sounds/SoundCollision.mp3")]//Embed Collision Sound file	
