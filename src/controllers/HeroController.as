package controllers 
{
	...
	public class HeroController
	{
		...
		public function HeroController(intObj: DisplayObject = null, stage:Stage = null, speed:Number = 3) 
		{
			this._object = intObj;
			this._stage = stage;
			...
			maxX = this._stage.stageWidth - this._object.width / 2;
			maxY = this._stage.stageHeight - this._object.height / 2;
...
//-------------------------------------------------------------------------------------------------
		...
		{
			setObjectPos();
			lookAtXY(Native.stage.mouseX, Native.stage.mouseY);
		}
		...
		public function setObjectPos():void 
		{
			...
			_object.x = _object.x + speedX;
			_object.y = _object.y + speedY;
		...
		public function lookAtXY(x:Number, y:Number):void
		{
			deltaX = x - _object.x;
			deltaY = y - _object.y;
			_object.rotation = Math.atan2(deltaY,deltaX) + Math.PI / 2;
		}
